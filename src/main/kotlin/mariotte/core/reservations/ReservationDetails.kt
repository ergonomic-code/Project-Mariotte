 ...
 * Если вкратце - из-за того, что Kotlin манглирует имена методов, которые возвращают value classes в SQL-запрос не включалась колонка period и в итоге Spring не мог создать прокси из-за того,
